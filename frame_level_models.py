...
flags.DEFINE_string("video_level_clf_model", "MoeModel", "")

# used in DBoF, VLAD, FV
flags.DEFINE_bool("batch_norm", True, "")
flags.DEFINE_bool("relu", False, "")

# used in DBoF
flags.DEFINE_integer("dbof_cluster_size", 4096, "")
flags.DEFINE_integer("dbof_hidden_size", 1024, "")

# used in DBoFModelLF
flags.DEFINE_string("dbof_activation", "relu", "")

# used in GatedDBoFModelLF, SoftDBoFModelLF
...
# used in NetFVModelLF
flags.DEFINE_integer("fv_cluster_size", 128, "")
